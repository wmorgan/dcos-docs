...
Specify the location of where the dcos installer is available from [dcos.io](dcos.io). Default: `https://downloads.dcos.io/dcos/EarlyAccess/{{ dcos_installer_filename }}`. The value of `{{ dcos_installer_file }}` is described above.
