...
*   5 [private](/docs/1.7/overview/concepts/#private) Mesos agent nodes is the default.
*   1 [public](/docs/1.7/overview/concepts/#public) Mesos agent node is the default.
...
1.  Launch the <a href="https://downloads.dcos.io/dcos/EarlyAccess/commit/14509fe1e7899f439527fb39867194c7a425c771/aws.html" target="_blank">DC/OS template</a> on CloudFormation and select the region and number of masters (1 or 3). You must have a key pair for your selected region.
