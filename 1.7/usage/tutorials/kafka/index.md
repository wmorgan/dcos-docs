...
Then, use the [framework cleaner](/docs/1.7/usage/services/#framework-cleaner) script to remove your Kafka instance from Zookeeper and to destroy all data associated with it. The script requires several arguments, the values for which are derived from your service name:
