...
DC/OS is a distribution of software that allows you to manage everything from two “machines” to thousands, as if they are a single computer. It automates placing processes, managing resources and configuring inter-process communication.
